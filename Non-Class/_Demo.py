...
def catch(va = 0,vb = 0, vc = 0, A0 = (0,0), B0 = (300,0),C0 = (150,180),duration = 20,step = 0.0001):
    ...
    animateF(*D,subj=[('Ax','Ay'),('Bx','By'),('Cx','Cy')],tail = 0,scale = 3)
...
def dampOsc(c = 0.1,m = 0.2,k = 20.0,x0 = 100,v0 = 0): #Example of Damped Oscillation
    ...
    X = rk4(0,20,0.0001,((x0,v0),(F1,F2)),'DampOsc c_%.1f,m_%.1f,k_%.1f'%(c,m,k),wCmd=())
...
def natural2(x0=1200,y0=450,z0=60,duration = 150,step = 0.001):
    ...
    writePLOT(*D,x=('x'),y=('y'))
    input('true')
    animateF(*D,subj=[('x','y')],tail = 0,scale = 10)
...
def showcase():
    ...
    input ('continue')
    catch(va = 20,vb = 30, vc = 50, A0 = (0,0), B0 = (700,0),C0 = (1500,800),duration = 40,step = 0.0001)
    input ('continue')
